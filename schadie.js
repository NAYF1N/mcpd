...
if (document.getElementById("check-aware").checked == false) {{{
  document.querySelector("textarea.radar").value = `SCHADIE I checked the calibration of my radar unit at the beginning of my shift, and I perform an internal systems check of my radar system after each traffic stop.
...
;
    {
    document.querySelector("textarea.lidar").value = `SCHADIE The LiDAR passed an internal systems check when it powered on.
